...
public class DatosArchivosTest extends AbstractTestCases {
	protected DatosArchivosManager datosArchivosManager;
...
/* public void testSettings() throws Exception {
 ...
 public void testSettings() throws Exception {
		try {
			PagedList pagedList = (PagedList)datosArchivosManager.ObtenerArchivos("", "", 0, 5);
