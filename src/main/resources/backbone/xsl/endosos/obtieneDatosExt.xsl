    ...
    <xsl:template match="rows">
        <xsl:for-each select="row">
        	<xsl:if test="@TIPOOBJETO = 1">
        		<ext-list xsi:type="java:com.biosnet.ice.ext.elements.form.SimpleCombo" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	                ...
	                <xsl:if test="@SWOBLIGA">
	                    <xsl:element name="force-selection">
	                        <xsl:value-of select="@SWOBLIGA"/>
	                    </xsl:element>
	                </xsl:if>
