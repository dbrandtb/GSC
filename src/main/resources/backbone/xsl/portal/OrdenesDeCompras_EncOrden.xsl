...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="rows">
        <xsl:for-each select="row">
            <item-list xsi:type="java:mx.com.aon.portal.model.OrdenDeCompraEncOrdenVO" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            ...
            <xsl:if test="@CONTRATANTE">
                <xsl:element name="contratante">
