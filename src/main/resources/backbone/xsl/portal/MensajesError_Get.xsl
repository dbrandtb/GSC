...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="rows">
        <xsl:for-each select="row">
            <item-list xsi:type="java:mx.com.aon.portal.model.MensajeErrorVO" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<xsl:if test="@DSTITLE">
				<xsl:element name="ds-msg-title">
					<xsl:value-of select="@DSTITLE" />
				</xsl:element>
			</xsl:if>
