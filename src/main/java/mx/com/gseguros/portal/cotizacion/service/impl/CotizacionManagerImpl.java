...
public class CotizacionManagerImpl implements CotizacionManager 
{
			...
			,String accion)throws Exception
	{
		logger.info(
				...
				.append("\n###### estado=")  .append(estado)
				.append("\n###### nmpoliza=").append(nmpoliza)
				.append("\n###### cdagrupa=").append(cdagrupa)
				.append("\n###### nmsuplem=").append(nmsuplem)
				.append("\n###### status=")  .append(status)
				.append("\n###### cdperson=").append(cdperson)
				.append("\n###### nmorddom=").append(nmorddom)
				.append("\n###### cdforpag=").append(cdforpag)
				.append("\n###### cdbanco=") .append(cdbanco)
				.append("\n###### cdsucur=") .append(cdsucur)
				.append("\n###### nmcuenta=").append(nmcuenta)
		...
		params.put("cdsucur"  , cdsucur);
		params.put("nmcuenta" , nmcuenta);
		params.put("ptajepag" , ptajepag);
		params.put("accion"   , accion);
		cotizacionDAO.movimientoMpoliagr(params);
		logger.info(
				new StringBuilder()
				.append("\n###### movimientoMpoliagr ######")
				.append("\n################################")
