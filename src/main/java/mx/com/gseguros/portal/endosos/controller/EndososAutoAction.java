...
public class EndososAutoAction extends PrincipalCoreAction
{
	...
	public String previewEndosoTvalositAuto()
	{
		logger.debug(Utils.log(
				 "\n#########################################"
		...
		try
		{
			...
			omap1 = endososAutoManager.previewEndosoTvalositAuto(
					cdtipsup
					,tstamp
					,cdunieco
					,cdramo
...
//			endososAutoManager.validarEndosoPagados(cdunieco, cdramo, estado, nmpoliza, cdtipsup);
	...
	public String previewEndosoVigenciaPoliza()
	{
		logger.debug(Utils.log(
				 "\n#########################################"
		...
		try
		{
			...
			smap2 = endososAutoManager.previewEndosoVigenciaPoliza(
					cdunieco,
					cdramo,
					estado,
					nmpoliza,
	...
	public String previewEndosoAmpliacionVigencia() {
		...
		try
		{
			...
			smap2 = endososAutoManager.previewEndosoAmpliacionVigencia(
					cdunieco,
					cdramo,
					estado,
					nmpoliza,
...
//			Date   dFechaEndoso  = renderFechas.parse(fechaEndoso);
	...
	public String previewEndosoDevolucionPrimas()
	{
		logger.debug(Utils.log(
				 "\n###########################################"
		...
		try
		{
			...
			omap1=endososAutoManager.previewEndosoDevolucionPrimas(
					user.getUser()
					,user.getRolActivo().getClave()
					,user.getEmpresa().getElementoId()
					,cdunieco
	...
	public String previewEndosoCancelacionPolAuto()
	{
		logger.debug(Utils.log(
				 "\n###############################################"
				,"\n###### previewEndosoCancelacionPolAuto ########"
				,"\n###### smap1 = " , smap1
				,"\n###### flujo = " , flujo
				));
		...
		try
		{
			...
			omap1 = endososAutoManager.previewEndosoCancelacionPolAuto(
					cdusuari
					,cdunieco
					,cdramo
					,estado
