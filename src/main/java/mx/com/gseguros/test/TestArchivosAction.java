...
public class TestArchivosAction extends PrincipalCoreAction {
	...
	public String validaArchivoExcel() throws Exception {
		...
		try {
			...
			campos.add(new CampoVO(CampoVO.FECHA, null, null, false));			//	46
			*/
			//campos.add(new CampoVO(CampoVO.NUMERICO, 1, 4, false));
			//campos.add(new CampoVO(CampoVO.NUMERICO, 1, 2, false));
			//campos.add(new CampoVO(CampoVO.ALFANUMERICO, 1, 1, false));
			//campos.add(new CampoVO(CampoVO.FECHA, null, null, false));
			//campos.add(new CampoVO(CampoVO.PORCENTAJE, 0, 20, false));
