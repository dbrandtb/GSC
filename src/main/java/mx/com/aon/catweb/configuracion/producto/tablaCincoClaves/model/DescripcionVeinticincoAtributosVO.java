package mx.com.aon.catweb.configuracion.producto.tablaCincoClaves.model;
...
public class DescripcionVeinticincoAtributosVO implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7612441182351352943L;
	...
	/**
	 * @param descripcion3 the descripcion3 to set
	 */
	...
	/**
	 * @param descripcion4 the descripcion4 to set
	 */
	...
	/**
	 * @param descripcion5 the descripcion5 to set
	 */
	...
	/**
	 * @param descripcion6 the descripcion6 to set
	 */
	...
	/**
	 * @param descripcion7 the descripcion7 to set
	 */
	...
	/**
	 * @param descripcion8 the descripcion8 to set
	 */
	...
	/**
	 * @param descripcion9 the descripcion9 to set
	 */
	...
	/**
	 * @param descripcion10 the descripcion10 to set
	 */
	...
	/**
	 * @param descripcion11 the descripcion11 to set
	 */
	...
	/**
	 * @param descripcion12 the descripcion12 to set
	 */
	...
	/**
	 * @param descripcion13 the descripcion13 to set
	 */
	...
	/**
	 * @param descripcion14 the descripcion14 to set
	 */
	...
	/**
	 * @param descripcion15 the descripcion15 to set
	 */
	...
	/**
	 * @param descripcion16 the descripcion16 to set
	 */
	...
	/**
	 * @param descripcion17 the descripcion17 to set
	 */
	...
	/**
	 * @param descripcion18 the descripcion18 to set
	 */
	...
	/**
	 * @param descripcion19 the descripcion19 to set
	 */
	...
	/**
	 * @param descripcion20 the descripcion20 to set
	 */
	...
	/**
	 * @param descripcion21 the descripcion21 to set
	 */
	...
	/**
	 * @param descripcion22 the descripcion22 to set
	 */
	...
	/**
	 * @param descripcion23 the descripcion23 to set
	 */
	...
	/**
	 * @param descripcion24 the descripcion24 to set
	 */
	...
	/**
	 * @param descripcion25 the descripcion25 to set
	 */
