package mx.com.aon.catweb.configuracion.producto.datosFijos.model;

import java.io.Serializable;

public class DatoFijoVO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 3455956587340250386L;
	private String codigoRamo;
	private String codigoFuncio;
	...
	/**
	 * @return the codigoFuncio
	 */
	public String getCodigoFuncio() {
		return codigoFuncio;
	}
	/**
	 * @param codigoFuncio the codigoFuncio to set
	 */
	public void setCodigoFuncio(String codigoFuncio) {
		this.codigoFuncio = codigoFuncio;
	}
	/**
	 * @return the codigoBloque
	 */
	public String getCodigoBloque() {
		return codigoBloque;
	}
	/**
	 * @param codigoBloque the codigoBloque to set
	 */
