...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Personas Aseguradas del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class PersonasAseguradasAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = -3514508167682490153L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en PersonasAseguradasAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en PersonasAseguradasAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en PersonasAseguradasAction...");
            logger.debug("######################################################");
        }
