...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Objetos del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class ObjetosAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = 6871323769750895831L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en ObjetosAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en ObjetosAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en ObjetosAction...");
            logger.debug("######################################################");
        }
