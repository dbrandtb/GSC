...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Agentes y Contratantes del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class AgentesContratantesAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = 7714490265831545291L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en AgentesContratantesAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en AgentesContratantesAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en AgentesContratantesAction...");
            logger.debug("######################################################");
        }
