...
public class AdministracionMantenimientoFaxAction extends ActionSupport {

	/**
	 * Logger de la clase para monitoreo y registro de comportamiento
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(AdministracionMantenimientoFaxAction.class);
	...
	public String cmdBorrarClick() throws Exception{
		...
		try{
			//messageResult = administracionMantenimientoDeFaxManager.borrarAdministracionFaxes();
            success = true;
	...
	public String cmdGetClick()throws Exception
	{
		try
		{
			...
			//AdministraFaxVO administraFaxVO=administracionMantenimientoDeFaxManager.getFormatosDocumentos(cdFormato);
	...
	public String cmdGuardarClick()throws Exception
	{
        ...
        try
        {
        	...
        	//administraFaxVO
        	//administraFaxVO
        	//messageResult = administracionMantenimientoDeFaxManager.guardarFormatosDocumentos(administraFaxVO);
            success = true;
            addActionMessage(messageResult);
            return SUCCESS;
     /*   }catch(ApplicationException e)
