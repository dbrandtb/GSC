...
public class ListaAdministracionAtributosFaxAction extends AbstractListAction{

	/**
	 * Logger de la clase para monitoreo y registro de comportamiento
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(ListaAdministracionAtributosFaxAction.class);
	...
	public String cmdBuscarClick() throws Exception{
		try{
            //PagedList pagedList = this.administracionAtributosDeFaxManager.buscarAdministracionFaxes(dsNomFormato, start, limit);
	 ...
	 * @throws Exception
	 */
	public String cmdExportarAdmAtrFaxClick() throws Exception{
		...
		//	TableModelExport model =  administracionAtributosDeFaxManager.getModel(dsNomFormato);
