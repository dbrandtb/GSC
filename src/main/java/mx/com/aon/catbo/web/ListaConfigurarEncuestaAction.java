...
public class ListaConfigurarEncuestaAction extends AbstractListAction{

	/**
	 * Logger de la clase para monitoreo y registro de comportamiento
	 */
	@SuppressWarnings("unused")
	private static Logger logger = Logger.getLogger(ListaConfigurarEncuestaAction.class);
	...
	public String cmdGetAsignacionEncuestaClick()throws Exception
	{
		try
		{
			...
			AsignarEncuestaVO asignarEncuestaVO = this.configurarEncuestaManager.getObtenerAsignacionEncuesta(pv_nmconfig_i, pv_cdunieco_i, pv_estado_i, pv_cdramo_i, pv_nmpoliza_i);
