 ...
 *
 */
public class ExportOpcMenuUsuarioAction extends ActionSupport{

	/**
	 *Serial Version 
	 */
	private static final long serialVersionUID = 5321518684242248834L;
	private static final transient Log log= LogFactory.getLog(ExportOpcMenuUsuarioAction.class);
