 ...
 *
 */
public class ExportOpcMenuUsuarioManagerImpl implements ExportModel {

	private static final transient Log log = LogFactory.getLog(ExportOpcMenuUsuarioManagerImpl.class);
