...
<link rel="stylesheet" type="text/css" media="screen" href="${ctx}/resources/css/screenDesigner/main.css" />
...
<jsp:include page="/resources/jsp-script/configurador/pantallas/configurador-script-beta.jsp" flush="true" /> 
