...
<title>Pre-Siniestros Beneficios - Vida y Gastos Funerarios</title>
...
<script language="javascript">
	...
	var _ACTION_GUARDA_PRE_VIDA_GASFUN = '<s:url namespace="/presiniestros" action="guardaPresiniestroVidaYGastosFunerarios" includeParams="none"/>';
...
<script type="text/javascript" src="${ctx}/resources/scripts/flujos/presiniestros/beneficios/capturaPresiniestroVidaYGastosFunerarios.js"></script>
