...
function getRegistro(){   
 storeRegistro = new Ext.data.Store({
         proxy: new Ext.data.HttpProxy({
               url: 'flujoendoso/obtenerDatosRegistroTarificacion.action'
           ...
           {name: 'polizaConfirmada', type: 'string',mapping:'cliente'},
           {name: 'importeTotal', type: 'string',mapping:'descripcion'},
           {name: 'recibo', type: 'string',mapping:'cdProceso'},
           {name: 'importeProrrateado', type: 'string',mapping:'descripcion'},
           {name: 'factor', type: 'string',mapping:'cliente'},
           {name: 'diferencia', type: 'string',mapping:'descripcion'},
           {name: 'modoPago', type: 'string',mapping:'cdProceso'},
           {name: 'primaTotal', type: 'string',mapping:'descripcion'},
           {name: 'primaModo', type: 'string',mapping:'descripcion'}
...
**************************************************************/ 
 ...
 var storeGrid;
  function getResultado(){
        url='flujoendoso/obtenerDatosGridTarificacion.action';
...
var tarificacionForm = new Ext.form.FormPanel({  
       layout:'form',
        id:'tarificacionForm',
        border:false,
        ...
        items: [{
                ...
                <s:component template="builderResultTarificacion.vm" templateDir="templates" theme="components" />
              },{
                border:false,
                bodyStyle:'margin-top: 15px; margin-left: 20px;',
                layout:'table',
                layoutConfig: {
                    columns: 2
                 },
                <s:component template="builderItemsTarificacion.vm" templateDir="templates" theme="components" />             
        }] 
        ...
        ,listeners: {
            beforerender  : function() {
                       ...
                       tarificacionForm.getForm().loadRecord(record);
                        });
          }//beforerender
       }//listeners
...
tarificacionForm.render('tarificacion');
