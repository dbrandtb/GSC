...
var nombre = new Ext.form.TextField({
		...
		tooltip: getToolTipFromMap('txtFldNmbrNtfcn', helpMap,'Nombre de la Notificaci&oacute;n'),  				                    	
        id: 'dsNotificacion', 
        name: 'dsNotificacion',
        allowBlank: false,
        width:260
...
var mensaje = new Ext.form.TextField({
		...
		tooltip: getToolTipFromMap('txtFldMnsjNtfcn', helpMap,'Mensaje de la Notificaci&oacute;n'),  				                    	
        id: 'dsFormatoOrden', 
        name: 'dsFormatoOrden',
        allowBlank: false,
        width:260
...
var procesoyTarea = new Ext.form.TextField({
		...
		tooltip: getToolTipFromMap('txtFldPrcsTrNtfcn', helpMap,'Proceso/Tareas de la Notificaci&oacute;n'),  				                    	
        id: 'procesoyTarea', 
        name: 'procesoyTarea',
        allowBlank: true,
        width:260
...
var comboFormato = new Ext.form.ComboBox(
{
    ...
    tooltip: getToolTipFromMap('cmbNtfEdtNomFormato',helpMap,'Formato a utilizar'),
    anchor:'100%',
    allowBlank: false,
...
var comboMetodoEnvio = new Ext.form.ComboBox(
{
    ...
    id:'comboMetEnvId',
    fieldLabel: getLabelFromMap('cmbNtfEdtDsMetEnv',helpMap,'M&eacute;todo Env&iacute;o'),
    tooltip: getToolTipFromMap('cmbNtfEdtDsMetEnv',helpMap,'M&eacute;todo Env&iacute;o a utilizar'),
    anchor:'100%',
    allowBlank: false,
    displayField:'descripcion',
    valueField: 'codigo',
    ...
    items: [
                ...
                buttons:[
                 {
                    ...
                    tooltip:getToolTipFromMap('dtlFrmtButtonDetalle', helpMap,'Muestra la pantalla formato de documento'),                               
                    handler: function () {
                        ventana()
                     }
                 }
            ...
            },
            {
                ...
                buttons:[
                        ...
                        tooltip:getToolTipFromMap('frmtDcmntButtonBuscar',helpMap,'Buscar un proceso o tarea'),
                        handler: function() {
