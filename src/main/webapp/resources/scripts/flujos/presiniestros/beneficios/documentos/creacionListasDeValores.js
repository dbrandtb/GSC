	...
	/**********************************************************************************************************************
	 *************** FUNCION TOMADA DEL ARCHIVO PARA EL WINDOW DE LA LISTA DE VALORES DE UNA CLAVE ************************
	 *********** /resources/scripts/jsp/utilities/atributosVariables/listasDeValores/listasDeValores.js *******************
	 * ********************************************************************************************************************
	 */
	function creaListasDeValores (dstore,edita,row){   
		 //***********************************************************
		...
		if(edita){
		                	...
		                	// check form value   
		                		...
		                		if (listasDeValoresForm.form.isValid()) {
			                	       ...
			                	       if(  Ext.getCmp('layoutColumnClaveMinMax').isVisible()
				            		          ...
				            		          if ( validaValorMinMax2 ( valorMinVal , valorMaxVal  )  ){
				                       ...
				                       if(  Ext.getCmp('id-minimo-desc-lista-valores').isVisible() &&
				                          Ext.getCmp('id-maximo-desc-lista-valores').isVisible()
				            		       ...
				            		       if( validaValorMinMax2 ( valorMinDesc , valorMaxDesc  )  ){
			...
			function validaValorMinMax2( valorMin , valorMax ){
