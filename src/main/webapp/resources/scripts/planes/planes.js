	...
	grid2= new Ext.grid.GridPanel({
		...
		buttons:[
            	...
            	handler: function(){
            		...
            		window.location.href = _IR_BUSCAR_PLANES+"?codigoProducto="+codigoProducto+"&codigoPlan="+codigoPlan+"&descripcionProducto="+descripcionProducto+"&descripcionPlan="+descripcionPlan;
            		}else{
