    ...
    var comboFuncionalidad = new Ext.form.ComboBox(
{
   ...
   // hiddenName: 'comboFuncionalidad',
    ...
    onSelect: function (record) {
    	      alert(  record.get('cdFunciona') );
             // this.setValue(record.get('cdfunciona'));
              Ext.getCmp('comboFuncionalidad').setValue( record.get('cdfunciona')  );
              this.collapse();
             }
   */          
            ...
            buttons:[
                  ...
                  tooltip: getToolTipFromMap('gridNtfcnBottonExportar',helpMap,'Exportar datos a diversos formatos'),
                    handler:function(){
                        ...
                        var url = _ACTION_BUSCAR_FUNCIONALIDADES_EXPORT + '?pv_nivel_i='+ Ext.getCmp('dsNivelId').getValue()+ '&pv_sisrol_i='+ Ext.getCmp('dsRolId').getValue() + '&pv_usuario_i=' + Ext.getCmp('dsUsuarioId').getValue() + '&pv_funciona_i=' + Ext.getCmp('comboFuncionalidad').getValue();
...
//alert(  "valueCombo=" +  Ext.getCmp('comboFuncionalidad').getValue() )   
...
function reloadGrid(){   
	var _params = {  
       				...
       				pv_funciona_i: Ext.getCmp('comboFuncionalidad').getValue()
       			  };
