function archivosPorMovimiento (caso,tarea,movimiento){
	...
	var grid = new Ext.grid.GridPanel({
			...
			buttons:[	/*{
                        ...
                        {
   		                    text:getLabelFromMap('btnMovCasoBorrarId',helpMap,'Borrar'),
		                    tooltip: getToolTipFromMap('btnMovCasoBorrarId',helpMap,'Borrar'),
		                    handler:function(){
                        ...
                        {
   		                    text: 'Consultar',// getLabelFromMap('btnMovCasoEditarId',helpMap,'Consultar'),
		                    tooltip: getToolTipFromMap('btnMovCasoEditarId',helpMap,'Consultar'),
                            handler:function(){
