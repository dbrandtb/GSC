...
var gridBusqueda;
	...
	var formBusqueda = new Ext.form.FormPanel({
		  id:'form',
	      el:'formBusqueda',
	      title: '<span style="color:black;font-size:12px;">'+getLabelFromMap('',helpMap,'Instrumentos de Pago por cliente')+'</span>',
	...
	var _cm = new Ext.grid.ColumnModel([
		{
        header: getLabelFromMap('',helpMap,'Instrumento de Pago'),
		dataIndex: 'dsForPag',
		sortable: true,
		width:200},
		{
	...
	gridBusqueda = new Ext.grid.GridPanel({
			...
			buttons:[
					...
					tooltip: getToolTipFromMap('',helpMap,'Agrega un nuevo Instrumento de Pago por cliente'),
            		handler:function(){agregarInstrumentoPorCliente(storeGrid);}
	            	},
	            	{
					text:getLabelFromMap('',helpMap,'Eliminar'),
					tooltip: getToolTipFromMap('',helpMap,'Elimina un Instrumento de Pago por cliente'),
            		handler:function()
            				{
					...
					tooltip: getToolTipFromMap('',helpMap,'Exporta los Instrumentos de Pago por cliente'),
                    handler:function(){}
	            	}],
	    	width:670,
	    	frame:true,
