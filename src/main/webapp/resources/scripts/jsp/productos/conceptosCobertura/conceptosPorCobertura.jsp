...
<!-- LIBRARIES -->
<!-- SOURCE CODE -->
<jsp:include page="/resources/scripts/jsp/utilities/conceptosCobertura/configurarConceptoCobertura.jsp" flush="true" />
...
<script type="text/javascript">
 ...
 //*************** grid conceptos por cobertura***********   
	...
	gridConceptoCobertura= new Ext.grid.GridPanel({
        	...
        	rowselect: function(sm, row, rec) {	                    		                    	                        	                     	                        
                            ...
                            Ext.getCmp('editar-ConceptosCobertura').on('click',function(){
                            		...
                            		if(afuera!=temporal){
                            			...
                            			configuraConceptoCobertura (storeConceptosCobertura,Ext.getCmp('hidden-codigo-combo-conceptos-cobertura').getValue(),temporal);
                            		}                                                                     
                                 });
                                 temporal=-1;
	                   	 }
        ...
        height:290,
    	frame:true,     
		title:'<s:text name="config.conceptos.cobertura.titulo"/>',
