...
if(row!=null){
   ...
   store.on('load', function(){ 
	...
	var apareceCotizadorCheck= new Ext.form.Checkbox({
                ...
                boxLabel: '<s:text name="productos.configAtributoObjeto.apareceCotizador"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
    ...
    var complementarioCheck= new Ext.form.Checkbox({
                ...
                boxLabel: '<s:text name="productos.configAtributoObjeto.complementario"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
	...
	var obligaComplementarioCheck= new Ext.form.Checkbox({
                ...
                boxLabel: '<s:text name="productos.configAtributoObjeto.obligatorioComplementario"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
     ...
     var modificableComplementarioCheck= new Ext.form.Checkbox({
                ...
                boxLabel: '<s:text name="productos.configAtributoObjeto.modificableComplementario"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
      ...
      var apareceEndosoCheck= new Ext.form.Checkbox({
                ...
                name:'apareceEndoso',
                boxLabel: '<s:text name="productos.configAtributoObjeto.apareceEndoso"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
       ...
       var obligatorioEndosoCheck= new Ext.form.Checkbox({
                ...
                boxLabel: '<s:text name="productos.configAtributoObjeto.obligatorioEndoso"/>',
            	hideLabel:true,	
                checked:false,
                onClick:function(){
				            	if(this.getValue()){
  ...
  /*          
    ...
    */        
    ...
    var atributoVariableObjetosWindow = new Ext.Window({
        title: '<s:text name="productos.configObjetos.title.datoVariableObjeto"/>',
        width: 615,
        height:440,
        layout: 'fit',
        plain:true,
        ...
        buttons: [{
                	...
                	if (datosVariablesForm.form.isValid()) {
		 		        	...
		 		        	datosVariablesForm.form.submit({			      
								    ...
								    Ext.MessageBox.alert('Status', 'El atributo variable se a guardado con exito');
