...
var _mcotiza_urlImprimirCotiza = '<s:property value="ruta.servidor.reports" />';
var _mcotiza_reportsServerUser = '<s:property value="pass.servidor.reports" />';
	    ...
	    _mcotiza_navView.down('[name=parametros.pv_otvalor03]').addListener('blur',function(comp)
        {
            ...
            Ext.Ajax.request(
            {
                ...
                ,success : function(response)
                {
                    ...
                    if(json.success)
                    {
                        var precioDolar = _mcotiza_navView.down('[name=parametros.pv_otvalor24]').getValue()-0;
