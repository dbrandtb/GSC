				...
				,columns       : [
					{
                        ...
                        header     : 'URGENCIAS MEDICAS <br/>HOMBRE',      dataIndex : 'URGENCIAMEDHOM',             width: 220,        hidden: true
                    },{
                        header     : 'URGENCIAS MEDICAS <br/>MUJER',       dataIndex : 'URGENCIAMEDMUJ',             width: 220,        hidden: true
                    }
				],
				bbar     :{
				displayInfo : true,
