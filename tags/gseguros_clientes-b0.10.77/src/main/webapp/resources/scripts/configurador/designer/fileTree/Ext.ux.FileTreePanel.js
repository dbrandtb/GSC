...
//				,menu:this.getContextMenu()
	...
	,openNode:function(node, mode) {
		...
		var url = _CONTEXT + '/resources/images/';
		var path;

		if(node.isLeaf()) {
			path = this.getPath(node);
			
			url = url + path + this.hrefSuffix;
	...
	,showContextMenu:function(node) {
		...
		//Se ha deshabilitado la opcion de renombrar, ya que genera problemas cuando hay imagenes en varias pantallas,
		//y por consiguientela imagen ya no es encontrada
