...
Ext.ux.ItemSelector = Ext.extend(Ext.form.Field,  {
    ...
    onRender: function(ct, position){
		...
		//if (this.imagePath!="" && this.imagePath.charAt(this.imagePath.length-1)!="/")
			//this.imagePath+="../../images/itemSelector/";
			this.imagePath = "./resources/images/itemSelector/";
	...
	refreshViews: function (newStore) {
        var range = newStore.getRange();
	...
	refreshToView: function (_store) {
		var rango = _store.getRange();
		this.toMultiselect.store.removeAll();
		this.toMultiselect.store.add(rango);
		this.toMultiselect.view.refresh();
	},
	
	refreshFromView: function (_store) {
		var rango = _store.getRange();
		this.fromMultiselect.store.removeAll();
		this.fromMultiselect.store.add(rango);
		this.fromMultiselect.view.refresh();
	}
});
