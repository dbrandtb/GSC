...
ExtComponents = {
 ...
 ['Elementos Cotizacion','Cotiza Autos',
                'Entrada',
                function(add,parent){
                 var config ={xtype:'fieldset' ,title:'Legend',autoHeight:true,items:[]};
                    config.items.push({
		...
		///Etiqueta
        data.push(
            ['Elementos Cotizacion','Etiqueta Personalizada',
		...
		data.push(
            ['Elementos Cotizacion','Agregar Imagen',
