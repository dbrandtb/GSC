...
<script>
   ...
   /*var datosgrid;
    ...
    var rechazaReclamacion   = '<s:url namespace="/siniestros"       action="rechazoReclamaciones" />';
...
Ext.onReady(function(){
    ...
    Ext.define('GridTareas',
    {
        ...
        ,initComponent : function()
        {
            ...
            Ext.apply(this,
            {
                ...
                [
                    ...
                    {    header     : 'P&oacute;liza'               		,dataIndex : 'nmpoliza'         ,width     : 90         },
                    ...
                    {	 xtype      : 'actioncolumn'						,menuDisabled : true			,header       : 'Acciones'       ,width        : 150,
                    	 items      :
	                        [
	                            {
	                            ...
	                            ,{
	                            	...
	                            	/*Generar Contra recibo*/
	                            	icon     : '${ctx}/resources/fam3icons/icons/accept.png'
	                                ,tooltip : 'Generar Contra recibo'
	                                ,handler : this.onContraReciboClick
	                            },{
	                            	/*Turnar a area de reclamaciones*/
        ...
        ,onContraReciboClick  : function(grid,rowIndex)
        {
        	Ext.Msg.show({
            	title:'onContraReciboClick',
            	msg: 'ENTRA A onContraReciboClick',
            	buttons: Ext.Msg.OK,
            	icon: Ext.Msg.WARNING
        	});
        }
