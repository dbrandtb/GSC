...
public interface PagerManager {
	 ...
	 * para poder limitar la consulta al tamano y posicion en la tabla.
	 *
	 ...
	 * @throws ApplicationException Excepcion con la informacion y descripcion del problema en la ejecucion
	 */
