...
public class MesaControlDAOImpl extends AbstractManagerDAO implements MesaControlDAO
{
	...
	public String cargarCdagentePorCdusuari(String cdusuari)throws Exception
	{
		...
		logger.debug(
				new StringBuilder()
				.append("\n****************************************************")
				.append("\n****** PKG_CONSULTA_PRE.P_GET_CDAGENTE_X_CDUSUARI ******")
			...
			)throws Exception
	{
		...
		logger.debug(
				new StringBuilder()
				.append("\n**********************************************")
				.append("\n****** PKG_SATELITES2_PRE.P_MOV_MESACONTROL ******")
				.append("\n****** params=").append(params)
				.append("\n**********************************************")
				.toString()
				);
			...
			)throws Exception
	{
		...
		logger.debug(
				new StringBuilder()
				.append("\n**********************************************")
				.append("\n****** PKG_SATELITES2_PRE.P_MOV_DMESACONTROL ******")
				.append("\n****** params=").append(params)
				.append("\n**********************************************")
				.toString()
				);
	...
	public void actualizarNmsoliciTramite(String ntramite,String nmsolici)throws Exception
	{
		...
		logger.debug(
				new StringBuilder()
				.append("\n*********************************************")
				.append("\n****** PKG_SATELITES_PRE.P_UPDATE_NMSOLICI ******")
				.append("\n****** params=").append(params)
				.append("\n*********************************************")
				.toString()
				);
			...
			,Map<String,String>valores)throws Exception
	{
		...
		logger.debug(
				new StringBuilder()
				.append("\n**********************************************")
				.append("\n****** PKG_SATELITES_PRE.p_upd_tmesacontrol ******")
				.append("\n****** params=").append(params)
				.append("\n**********************************************")
				.toString()
				);
			...
			)throws Exception
	{
		...
		logger.debug(Utils.log(
				 "\n*********************************************************"
				,"\n****** PKG_SATELITES2_PRE.P_GET_TMESACONTROL_X_PAR_VAR ******"
				,"\n****** params=",params
				,"\n*********************************************************"
				));
	...
	public void guardarRegistroContrarecibo(String ntramite,String cdusuari)throws Exception
	{
		...
		params.put("ntramite" , ntramite);
		params.put("cdusuari" , cdusuari);
		Utils.debugProcedure(logger, "PKG_SATELITES2_PRE.P_INSERTA_CONTRARECIBO", params);
	...
	public void actualizarNombreDocumento(String ntramite,String cddocume,String nuevo)throws Exception
	{
		...
		Utils.debugProcedure(logger, "PKG_SATELITES2_PRE.P_UPD_TDOCUPOL_DSDOCUME", params);
	...
	public void borrarDocumento(String ntramite,String cddocume)throws Exception
	{
		...
		params.put("ntramite" , ntramite);
		params.put("cddocume" , cddocume);
		Utils.debugProcedure(logger, "PKG_SATELITES2_PRE.P_BORRAR_TDOCUPOL", params);
			...
			,String cdpos)throws Exception
	{
		...
		Utils.debugProcedure(logger, "PKG_SATELITES2_PRE.P_ELIMINA_MDOMICIL_ASEGURADOS", params);
	...
	public void guardarDocumento(String cdunieco, String cdramo, String estado,
		...
		Utils.debugProcedure(logger, "PKG_SATELITES2_PRE.P_MOV_DOCUMENTOS", params);
			...
			)throws Exception
	{
		...
		logger.debug(Utils.log("****** PKG_SATELITES2_PRE.P_OBTIENE_MESACONTROL lista=",lista));
		return lista;
	}
			...
			)throws Exception
	{
		...
		logger.debug(Utils.log("\n****** PKG_SATELITES2_PRE.P_MARCA_IMPRESION_OPE result=",result));
		return result;
	}
	...
	/*******************************************************************/
	/*  Se agrega PKG_DB_REPORT_PRE.P_REVERSA_STATUS_IMPRESO
