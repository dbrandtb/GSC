		...
		try
		{
			...
			if(slist1 == null || slist1.isEmpty()){
		    	...
		    	if(clientesRes == null || (Estatus.EXITO.getCodigo() != clientesRes.getCodigo())){
		    		...
		    		exito           = false;
					respuesta       = "No se encontr� ninguna persona. Consulte a soporte.";
					respuestaOculta = "No se encontr� ninguna persona. Consulte a soporte.";
					slist1          = null;
	...
	public String importaPersonaExtWS()
	{
		...
		try
		{
			...
			if(clientesRes == null || (Estatus.EXITO.getCodigo() != clientesRes.getCodigo())){
				...
				logger.debug("Error en WS, exito false");
				exito           = false;
				respuesta       = "No se encontr� ninguna persona al Importar. Consulte a soporte.";
				respuestaOculta = "No se encontr� ninguna persona al Importar. Consulte a soporte.";
				slist1          = null;
		...
		try
		{
			...
			if(exito){
		    	...
		    	if(clientesRes == null || (Estatus.EXITO.getCodigo() != clientesRes.getCodigo())){
		    		...
		    		logger.debug("Error en WS, exito false");
		    		exito           = false;
					respuesta       = "No se encontr&oacute; ninguna persona al Guardar. Consulte a soporte.";
					respuestaOculta = "No se encontr&oacute; ninguna persona al Guardar. Consulte a soporte.";
					slist1          = null;
