	...
	*/
	public String guardaAutorizacionServicio(){
		...
		try {
			...
			//1.- Eliminacion de la tabla TDETAUTS ---> PKG_PRESINIESTRO_PRE.P_BORRA_TDETAUTS
			siniestrosManager.getEliminacionRegistros(params.get("nmautser"));
			//2.- Agregar informacion PKG_PRESINIESTRO_PRE.P_GUARDA_MAUTSERV2
			...
			if(lista!=null && !lista.isEmpty()) {
				...
				for(int i=0;i<datosTablas.size();i++) {
					...
					//3.- Se guarda la informacion en PKG_PRESINIESTRO_PRE.P_GUARDA_TDETAUTS
