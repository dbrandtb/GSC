...
public class CotizacionAutoAction extends PrincipalCoreAction
{
	...
	public String cargarRetroactividadSuplemento()
	{
		...
		try
		{
			...
			checkBlank(cdunieco , "No se recibi贸 la sucursal");
			checkBlank(cdramo   , "No se recibi贸 el producto");
			checkBlank(cdtipsup , "No se recibi贸 el tipo de suplemento");
			checkBlank(cdusuari , "No se recibi贸 el nombre de usuario");
			checkBlank(cdtipsit , "No se recibi贸 la modalidad");
