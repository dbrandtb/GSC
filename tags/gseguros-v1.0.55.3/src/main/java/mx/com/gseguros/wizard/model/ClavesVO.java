 ...
 * @author Edgar Perez
 * @version 2.0
 *Clase que contiene las claves para la tabla de 1 y 5 claves sus getters y setters 
 */

public class ClavesVO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -89075964445220358L;
