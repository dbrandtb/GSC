...
Main.prototype = {
    ...
    init: function() {
        ...
        //atributo cookies (CookieProvider)
        ...
        this.viewport = new Ext.Viewport({
            layout : 'border',
                items: [{
                    ...
                    // tabla de botones...
                    tbar    : [{
                            // boton de eliminar, handler invoca a funciones markUndo y resetAll()...
                            text : 'Eliminar todo',
                            iconCls:'icon-reset',
                            scope: this,
                            handler:function() {
                                this.markUndo("Eliminar todo");
                                this.resetAll();
                            }
                        },{
                            // boton de edicion de JSON, el handler invoca a atributo THIS.EDITCONFGI ....
                            text:'Show/Edit JSON',
                            iconCls:'icon-editEl',
                            scope:this,
                            handler:this.editConfig
                        },'-',{
                            // boton de actualizar, el handler invoca a funcion updateform                            
                            iconCls : 'icon-update',
                            text    : 'Actualizar',
                            ...
                            //el control radio al estar checado invoca al atributo autoUpdate...
                            xtype    : 'checkbox',
                            boxLabel : 'Auto',
                            id       : 'FBAutoUpdateCB',
                            ...
                            //este boton el handler invoca a la funcion updateForm...
                            iconCls : 'icon-time',
                            ...
                            // este boton el handler invoca un message alert de ext..
                            text    : 'Salvar',                         
                            handler : function() {
                                Ext.Msg.alert('Salvar'," Salvando la forma..");
                            }
                        }
                    ] //area de botones...
                },
                {
                	...
                	//PANEL CON ELEMENTOS QUE SE AGREGAN EN PANTALLA
...
///////////////////////
    ...
    initComponentsPanel : function() {
        ...
        var tb = ['<b>Categorias de Componentes : </b>', {
                text         : 'Todas',
