...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" 
    ...
    <xsl:template match="rows">
        <xsl:for-each select="row">
            <item-list xsi:type="java:mx.com.aon.portal.model.principal.RolVO" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
				...
				<xsl:if test="@DSCONTENIDO">
					<xsl:element name="contenido-dato">
						<xsl:value-of select="@DSCONTENIDO"/>
					</xsl:element>
				</xsl:if>
		        <xsl:if test="@DSCONTENIDOSEC">
		            <xsl:element name="contenido-dato-sec">
