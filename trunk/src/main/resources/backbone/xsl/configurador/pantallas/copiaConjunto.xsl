    ...
    <xsl:template match="/">
		<wrapper-resultados
			...
			<xsl:element name="resultado">
			       <xsl:value-of select="result/storedProcedure/outparam[@id='pv_cdconjunto_dest_o']/@value" />
			</xsl:element>
        ...
        <!--conjunto-pantalla-vO xsi:type="java:com.aon.catweb.configurador.pantallas.model.ConjuntoPantallaVO" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
