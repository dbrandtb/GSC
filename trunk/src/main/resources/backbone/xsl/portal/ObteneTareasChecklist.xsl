...
<inciso-vO xsi:type="java:com.biosnet.ice.wizard.productos.incisos.model.IncisoVO"> <!-- Aqui ponemos nuestro VO -->
...
<xsl:if test="@SWSITDEC">
<xsl:element name="swsitdec">
<xsl:value-of select="@SWSITDEC"/>
</xsl:element>
</xsl:if>
</inciso-vO>
</xsl:template>
