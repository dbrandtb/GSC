 ...
 *
 */
public abstract class AbstractListAction extends ActionSupport {
     ...
     */
    protected int limit = (tl.get().getTamagnoPaginacionGrid() > 0)?tl.get().getTamagnoPaginacionGrid():20;
