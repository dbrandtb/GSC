...
public class ValoresTablaCincoClavesAction extends Padre {
	...
	public String listaAtributosEditableJson() throws Exception {
		...
		DescripcionVeinticincoAtributosVO desctipcionAtributos = tablaCincoClavesManager.obtieneDescripcionAtributosCincoClaves(numEditable);
		...
		listaAtributosEditable.addAll(tablaCincoClavesManager.obtieneValorDummyAtributos("dummy" , desctipcionAtributos));
		
		
		if(listaClavesEditable!=null){
			for(DescripcionCincoClavesVO descripCincoClaves : listaClavesEditable){
				listaAtributosEditable.addAll(tablaCincoClavesManager.obtieneValoresAtributos(numEditable , descripCincoClaves, desctipcionAtributos));
			}
		}
...
try{
	...
	public String insertarValoresTablaCincoClaves()throws Exception{
		...
		List<DescripcionCincoClavesVO> clavesNoInsertadas = tablaCincoClavesManager.insertaValoresCincoClaves(numeroTabla , listaValores5ClavesParams);
	...
	// Getters && Setters
	/**
	 * @param tablaCincoClavesManager
	 *            the tablaCincoClavesManager to set
	 */
