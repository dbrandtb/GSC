package mx.com.aon.catweb.configuracion.producto.sumaAsegurada.web;
...
public class SumaAseguradaAction extends Padre {
	...
	public String catalogosSumaAsegurada() throws Exception{
		...
		if(catalogo.equals("tipoSumaAsegurada")){				
			catalogoTipoSumaAsegurada = sumaAseguradaManager.catalogoTipoSumaAsegurada();
				/*if(isDebugEnabled){
		...
		if(catalogo.equals("sumaAsegurada")&& codigoRamo!= null){
			catalogoSumaAsegurada = sumaAseguradaManager.catalogoSumaAsegurada(codigoRamo);
		}
		
		if(catalogo.equals("monedaSumaAsegurada")){
			catalogoMoneda = sumaAseguradaManager.catalogoMonedaSumaASegurada();
		}
		if(catalogo.equals("gridSumaAsegurada")&& codigoRamo!=null){
			codigoCapital = null;
			//codigoRamo="777";//solo para prueba
			listaSumasAseguradas = sumaAseguradaManager.listaSumaAsegurada(codigoRamo,codigoCapital);
			/*if(isDebugEnabled){
		...
		if(catalogo.equals("gridSumaAseguradaInciso")&& codigoRamo!=null && codigoCobertura!=null && codigoTipoSituacion!=null){
			codigoCapital = null;			
			listaSumasAseguradasInciso = sumaAseguradaManager.listaSumaAseguradaInciso(codigoRamo,codigoCobertura,codigoCapital,codigoTipoSituacion);			
		}
    ...
    public String eliminarSumaAsegurada() throws Exception {
      ...
      if(nivel.equals("producto")){
    	  if(codigoCapital != null && codigoRamo!=null){
    		  sumaAseguradaManager.eliminaSumaAseguradaProducto(codigoCapital,codigoRamo);
    		  //if(isDebugEnabled){
    	  ...
    	  if(codigoCapital != null && codigoRamo!=null && codigoTipoSituacion!=null){
    		  sumaAseguradaManager.eliminaSumaAseguradaInciso(codigoCapital,codigoRamo,codigoTipoSituacion);
    		  //if(isDebugEnabled){
