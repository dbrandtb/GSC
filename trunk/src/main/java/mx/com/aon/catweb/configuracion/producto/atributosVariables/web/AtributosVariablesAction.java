...
public class AtributosVariablesAction extends ExpresionesPadre {
	...
	public String validaHijosAtributoVariable() throws Exception {
		...
		switch(nivel){
			case 1 :
				endpointName = "VALIDA_HIJOS_ATRIB_VAR_PRODUCTO";
				log.debug("tipo :Producto");
				break;
			case 2 :
				endpointName = "VALIDA_HIJOS_ATRIB_VAR_INCISO_RIESGO";
				log.debug("tipo :Riesgo/Inciso");
				break;
			case 3 :
				endpointName = "VALIDA_HIJOS_ATRIB_VAR_COBERTURA";
		...
		if(StringUtils.isNotBlank(endpointName)){
			if(atributosVariablesManager.tieneHijosAtributoVariable(endpointName, atributoVariable)){
