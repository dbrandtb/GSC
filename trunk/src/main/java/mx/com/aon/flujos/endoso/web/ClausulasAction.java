...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Clausulas del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class ClausulasAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = 7697026074435791981L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en ClausulasAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en ClausulasAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en ClausulasAction...");
            logger.debug("######################################################");
        }
