...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de coberturas y sumas aseguradas del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class CoberturasSumasAseguradasAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = 2082391698358278692L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en CoberturasSumasAseguradasAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en CoberturasSumasAseguradasAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en CoberturasSumasAseguradasAction...");
            logger.debug("######################################################");
        }
