...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla Incisos del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class AgrupadoresIncisosAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = 5667572041175729806L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en AgrupadoresIncisosAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en AgrupadoresIncisosAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en AgrupadoresIncisosAction...");
            logger.debug("######################################################");
        }
