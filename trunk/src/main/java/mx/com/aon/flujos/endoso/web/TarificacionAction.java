...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Tarificacion del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class TarificacionAction extends PrincipalEndosoAction {

    /**
     * 
     */
    private static final long serialVersionUID = -1665596795595740782L;
    ...
    public void validate() {
        ...
        logger.debug("### Llegando a validate en TarificacionAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en TarificacionAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if (isDebugueable) {
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en TarificacionAction...");
            logger.debug("######################################################");
        }
