...
/**
 * 
 * Clase Action para el control y visualizacion de datos de la pantalla de Grupos del proceso de endosos
 * 
 * @author aurora.lozada
 * 
 */
public class GruposAction extends PrincipalEndosoAction{

    /**
     * 
     */
    private static final long serialVersionUID = 2912214365429852776L;
    ...
    public void validate() {
           ...
           logger.debug("### Llegando a validate en GruposAction...");
    ...
    public String obtenerDatosGrid() throws Exception {
        ...
        if(isDebugueable){
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosGrid en GruposAction...");
            logger.debug("######################################################");
        }
    ...
    public String obtenerDatosRegistro() throws Exception {
        ...
        if(isDebugueable){
            logger.debug("######################################################");
            logger.debug("### Llegando a metodo obtenerDatosRegistro en GruposAction...");
            logger.debug("######################################################");
        }
