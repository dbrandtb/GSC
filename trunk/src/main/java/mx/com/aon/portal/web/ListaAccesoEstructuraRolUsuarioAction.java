...
import mx.com.aon.portal.model.AccesoEstructuraRolUsuarioVO;
...
public class ListaAccesoEstructuraRolUsuarioAction extends AbstractListAction {
	...
	public String cmdBuscarClick() throws ApplicationException {
		try {
			PagedList pagedList = accesoEstructuraRolUsuarioManager.buscarAccesos(dsNivel, dsRol, dsUsuario, dsNombre, dsEstado, start, limit);
