...
public class RecuperacionSimpleManagerImpl_GDH implements RecuperacionSimpleManager
{
	private Map<String,Object>session;
	
	private final static Logger logger=LoggerFactory.getLogger(RecuperacionSimpleManagerImpl_GDH.class);
