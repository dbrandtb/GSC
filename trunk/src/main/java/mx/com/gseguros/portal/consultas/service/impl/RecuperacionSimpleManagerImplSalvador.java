...
public class RecuperacionSimpleManagerImplSalvador implements RecuperacionSimpleManager
{
	private Map<String,Object>session;
	
	private final static Logger logger=LoggerFactory.getLogger(RecuperacionSimpleManagerImplSalvador.class);
