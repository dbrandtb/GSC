...
/**
 * <p>Clase Java para wsRecuperaCotizacionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="wsRecuperaCotizacionResponse">
 *   &lt;complexContent>
...
@XmlType(name = "wsRecuperaCotizacionResponse", propOrder = {
    "_return"
})
public class WsRecuperaCotizacionResponse {
