...
var _cdTipSupCambioNombre = '<s:property value="@mx.com.gseguros.portal.general.util.TipoEndoso@CAMBIO_NOMBRE_CLIENTE.cdTipSup" />';
...
//	            }
     ...
     Ext.Ajax.request(
    {
        ...
        ,params  :
        {
            ...
            ,'smap1.estado'       : _35_smap1.ESTADO
            ,'smap1.nmpoliza'     : _35_smap1.NMPOLIZA
            ,'smap1.cdtipsup'     : _cdTipSupCambioNombre
        }
        ,success : function(response)
        {
            var json = Ext.decode(response.responseText);
