                                    ...
                                    columns : [
                                            ...
                                            },
                                            {
                                                ...
                                                renderer : function(value) {
                                                    var rvalue = '';
                                                    if (value == 'N') {
                                                        rvalue = '<img src="${ctx}/resources/fam3icons/icons/eye.png" data-qtip="Ver datos adicionales" style="cursor:pointer;">';
                                                    }
                                                    return rvalue;
                                                }
                                            },
                                            {
                                                ...
                                                renderer : function(value) {
                                                    var rvalue = '';
                                                    if (value == 'N') {
                                                        rvalue = '<img src="${ctx}/resources/fam3icons/icons/pencil.png" data-qtip="Editar suma asegurada" style="cursor:pointer;">';
                                                    }
                                                    return rvalue;
                                                }
                                            },
                                            {
                                                ...
                                                renderer : function(value) {
                                                    var rvalue = '';
                                                    if (value == 'N') {
                                                        rvalue = '<img src="${ctx}/resources/fam3icons/icons/delete.png" data-qtip="Quitar cobertura" style="cursor:pointer;">';
                                                    }
                                                    return rvalue;
                                                }
                                            } ],
