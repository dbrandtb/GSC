...
var _p21_urlSubirCensoCompleto2         = '<s:url namespace="/siniestros"   action="subirexcelConfiguracion2"          />';
...
var msgWindow;
                    ...
                    [
                        {
                            text     : 'Cargar archivo'
                            ,icon    : '${ctx}/resources/fam3icons/icons/group_edit.png'
                            ,handler : function(me){ _p21_subirArchivoParametrizadosLayout2(me); } //_p21_subirArchivoParametrizadosLayout
                        }
                    ]
                })
            ]
    ...
    function _p21_subirArchivoParametrizadosLayout2(button,nombreCensoParaConfirmar)
    {
        var form=button.up().up();
        var valido=form.isValid();
        if(!valido)
                	...
                	Ext.Ajax.request({
            			...
            			,success : function (response){
            				...
            				if( Ext.decode(response.responseText).validacionGeneral =="S"){
        							...
        							Ext.Ajax.request(
		                    		{
				                        url       : _p21_urlSubirCensoCompleto2
				                        ,jsonData :
				                        {
				                            smap1   : conceptos
				                            ,olist1 : grupos
