...
{
  var selObj = Ext.getDom('copiaPantallas');
  ...
  buttons:[{                               
             ...
             selectAllOptions();
                        if (copiadoFormPanel.form.isValid()) {
                         ...
                         url:'configuradorpantallas/copiarConjunto.action',
                              waitMsg:'Procesando...',
                                     failure: function(form, action) {
                                           Ext.MessageBox.alert('Copia Finalizada', 'El nivel seleccionado no cuenta con el producto del original');
                                                   },
...
<s:form id="formList" action="copiarConjunto"  method="post" namespace='/configuradorpantallas'>
<s:optiontransferselect 
     ...
     listValue="label"
     doubleSize ="15" 
     doubleId="copiaPantallas"
     doubleName="copiaPantallas"
