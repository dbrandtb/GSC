...
//////////////////////////
        ...
        var _ACTION_CARGA_ITEMS = "<s:url action='cargaItems' namespace='/flujoendoso'/>";
        var _ACTION_CUENTA_COBERTURAS = "<s:url action='cuentaCoberturas' namespace='/flujoendoso'/>";
        var _ACTION_GUARDA_COBERTURAS = "<s:url action='agregarCoberturas' namespace='/flujoendoso'/>";
        var _ACTION_LISTA_COBERTURAS = "<s:url action='coberturasIncisosEndoso' namespace='/flujoendoso'/>";
        var _ACTION_CARGA_COBERTURAS = "<s:url action='listaCoberturasSelect' namespace='/flujoendoso'/>";
        var _ACTION_EDITAR_COBERTURA = "<s:url action='editarCoberturas' namespace='/flujoendoso'/>";
        
        var _ACTION_CARGA_TIPOS_ACCESORIOS = "<s:url action='cargaListaTipoAccesorios' namespace='/flujoendoso'/>";
        var _ACTION_CARGA_ITEMS_ACCESORIOS = "<s:url action='cargaItemsAccesorios' namespace='/flujoendoso'/>";
        var _ACTION_GUARDA_ACCESORIO = "<s:url action='guardaAccesorio' namespace='/flujoendoso'/>";
        var _ACTION_EDITAR_ACCESORIO = "<s:url action='editarAccesorio' namespace='/flujoendoso'/>";
        ...
        var _cdtipsit       = '<s:property value="cdTipsit" />';
...
var datosIncisosForm = new Ext.form.FormPanel({
    ...
    /*items:  ElementosExt,*/
    items: 
	<s:component template="camposPantallaDatosExt.vm" templateDir="templates" theme="components" >
		<s:param name="dext" value="extDatosElements" />
	</s:component>,
    autoScroll:true,
    buttons:[
	<s:component template="botonVariablesExt.vm" templateDir="templates" theme="components" >
		<s:param name="botonDatVariables" value="botonDatVariables" />
	</s:component>
	]
});
