...
.inputText {
 ...
 .optiontransferselect{
            ...
            border: 1px solid #999999; margin-left: auto; margin-right: auto;
            width: 250px;
        } 
...
<jsp:include page="/resources/jsp-script/configurador/pantallas/configurador-script.jsp" flush="true" />
