...
<script language="javascript">
    ...
    var CODIGO_NIVEL="<s:property value='cdNivel'/>";
    var CODIGO_ROL = "<s:property value='cdRol'/>";
    var CODIGO_USUARIO = "<s:property value='cdUsuario'/>";
    var CODIGO_FUNCIONALIDAD = "<s:property value='cdFunciona'/>";
...
<script type="text/javascript" src="${ctx}/resources/scripts/portal/configuracionFuncionalidadesPrivilegios/configuracionFuncionalidadesPrivilegiosEditar_stores.js"></script>
<script type="text/javascript" src="${ctx}/resources/scripts/portal/configuracionFuncionalidadesPrivilegios/configuracionFuncionalidadesPrivilegiosEditar.js"></script>
