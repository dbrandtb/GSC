...
<script language="javascript">
    var _CONTEXT = "${ctx}";
    var _ACTION_OBENER_CAMPOS_BUSQUEDA = "<s:url action='obtenerDatosGrilla' namespace='/configurarCatalogos'/>";
    var _ACTION_GUARDAR_REGISTRO = "<s:url action='guardarRegistro' namespace='/configurarCatalogos'/>";
    var _ACTION_ACTUALIZAR_REGISTRO = "<s:url action='actualizarRegistro' namespace='/configurarCatalogos'/>";
    var _ACTION_BORRAR_REGISTRO = "<s:url action='borrarRegistro' namespace='/configurarCatalogos'/>";
    var _ACTION_EXPORTAR = "<s:url action='exportarCatalogosSimples' namespace='/configurarCatalogos'/>";
	...
	*/
    ...
    var gridColumModel = <%if (session.getAttribute("camposForm") != null) {%> <%=session.getAttribute("gridColumnModel")%> <%;} else {%>[{header: ''}]; <%}%>
...
<script type="text/javascript" src="${ctx}/resources/scripts/portal/configuradorCatalogos/agregarRegistrosCatalogosSimples.js"></script>
<script type="text/javascript" src="${ctx}/resources/scripts/portal/configuradorCatalogos/editarRegistrosCatalogosSimples.js"></script>
<script type="text/javascript" src="${ctx}/resources/scripts/portal/configuradorCatalogos/configuradorCatalogosSimples.js"></script>
