...
<script language="javascript">
  ...
  //  var _ACTION_BUSCAR_USUARIOS = "<s:url action='buscarNotificacionesProcesos' namespace='/notificaciones'/>";
   ...
   // var _ACTION_GUARDAR_USUARIO = "<s:url action='buscarNotificacionesProcesos' namespace='/notificaciones'/>";
    ...
    //var _ACTION_OBTENER_CLIENTE_CORPO = "<s:url action='obtenerClientesCorp' namespace='/combos-catbo'/>";
    var _ACTION_OBTENER_CLIENTE_CORPO = "<s:url action='comboClientesCorpBO' namespace='/combos-catbo'/>";
    
    //var _ACTION_OBTENER_PRODUCTOS = "<s:url action='obtenerProductos' namespace='/combos-catbo'/>";
    ...
    var _ACTION_COMBO_STATUS = "<s:url action='obtenerEstadoEjecutivo' namespace='/combos-catbo'/>";
     ...
     var _OBTENER_PROCESOS = "<s:url action='obtenerComboProcesosCatMatriz' namespace='/combos-catbo'/>";
   
      var helpMap = new Map();
        var itemsPerPage=_NUMROWS;
    <%=session.getAttribute("helpMap")%>
    <%=((ToolTipBean)pageContext.getServletContext().getAttribute("toolTipName")).getHelpMap("803")%>
    
    var CDNIVATN = "";
    
    _URL_AYUDA = "/backoffice/agrMatrizAsignacion.html";
...
<script type="text/javascript" src="${ctx}/resources/scripts/configuraMatrizTarea/configurarMatrizTarea.js"></script>
