...
<script language="javascript">
	...
	function actual( componente ){
		...
		var lista = document.getElementById("nav_lista");
...
<ul id="nav_lista">
	<s:iterator id="listaMenu" value="listaMenu" status="st">
		<li id="<s:property value='id'/>"
			<s:if test="#st.first">class="active_menu"</s:if>><a href="#"
			onClick="actual('<s:property value='id'/>');"> <s:property
			value='texto' /> </a></li>
	</s:iterator>
	<li><a href="<s:url action='logoff' namespace='/portal'/>">Salir</a></li>
</ul>
</body>
</html>
