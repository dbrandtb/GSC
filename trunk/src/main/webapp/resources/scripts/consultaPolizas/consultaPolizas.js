function obtenerPolizas(_cdperson){	
	...
	var grid = new Ext.grid.GridPanel({
			...
			buttons:[
		            		...
		            		handler:function(){
		            			if(getSelectedRecord(grid) != null){
		            				if(CONSULTA_CLIENTE_SCREEN){
		            					...
		            					valida_tconfigencuesta(getSelectedRecord(grid).get('cdunieco'),getSelectedRecord(grid).get('cdramo'));
		            					ventana.close();
		            				}else{
		            	...
		            	},
		            	{
						    ...
						    handler:function(){
							    if(getSelectedRecord(grid) != null){
							    	//window.location = _IR_BUSQUEDA_POLIZA +'?_cdperson='+CDPERSON +'&nmpoliex='+getSelectedRecord(grid).get('nmpoliex');
	...
	var formPanel = new Ext.FormPanel({
		...
		/*grid.store.load({
			params:{cdPerson:(_cdperson)?_cdperson:CDPERSON,cdElemento:CDELEMEN},
			callback:function(){
	...
	function reloadGridPoliza(){
		var _params = {cdPerson:(cdPersonParam)?cdPersonParam:CDPERSON,
					   cdElemento:CDELEMEN};		
