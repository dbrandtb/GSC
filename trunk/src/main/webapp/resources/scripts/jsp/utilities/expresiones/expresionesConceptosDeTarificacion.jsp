...
ExpresionesVentanaTarificaciones = function(storeTarificacion,rec,row) {
var codigoExpresion;

if(row!=null){
	
	var record = storeTarificacion.getAt(row);
    codigoExpresion= record.get('codigoExpresion');
    
	storeTarificacion.on('load', function(){
                           Ext.getCmp('cabecera-tarificacion-form').getForm().loadRecord(record);
		...
		*************************/
    	...
    	storeExpresion.on('load', function(){
                           ...
                           Ext.getCmp('conceptos-de-tarificacion').getForm().loadRecord(rec);
                           if(swRecalcular == 'S'){
...
****************************************/
	...
	***************************************************************/
	...
	var cabecera = new Ext.form.FormPanel({
                ...
                items: [{xtype:'hidden',id:'hidden-descripcion-expresion',name:'descripcionExpresion'},
						...
						{xtype:'hidden',id:'hidden-combo-tipo-tarificacion',name:'tipo'},
						{
 				    		border: false,
 				    		layout: 'form',
				    		items: [{
	...
	****************************************************************/
    var tab2 = new Ext.FormPanel({
			        ...
			        bodyBorder:false,
			        id:'top-conceptos-de-tarificacion',
