...
ExpresionesVentanaAutorizaciones = function(storeAutorizaciones,rec,row) {
var codigoExpresion;

if(row!=null){
	
	var record = storeAutorizaciones.getAt(row);
    codigoExpresion= record.get('codigoExpresion');
    
	storeAutorizaciones.on('load', function(){
                           //var record = storeAutorizaciones.getAt(row);
                           Ext.getCmp('cabecera-autorizaciones-form').getForm().loadRecord(record);
		...
		*************************/
    	...
    	storeExpresion.on('load', function(){
                           ...
                           Ext.getCmp('top-autorizaciones').getForm().loadRecord(rec);
                           if(swRecalcular == 'S'){
...
****************************************/
	...
	***************************************************************/
	...
	var cabecera = new Ext.form.FormPanel({
            	...
            	id:'cabecera-autorizaciones-form',
