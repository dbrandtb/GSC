...
var ds = new Ext.data.Store({
	...
	var comboWithTooltip = new Ext.form.ComboBox({
    	...
    	allowBlank:false,
    	blankText : '<s:text name="productos.configIncisoSumaAsegurada.listaValor.req"/>',
    	//maxLength : '30',
    	//maxLengthText : 'Treinta caracteres maximo',
    	typeAhead: true,
    	mode: 'local',
    	triggerAction: 'all',
    	emptyText:'<s:text name="productos.configIncisoSumaAsegurada.listaValor.sel"/>',
    	selectOnFocus:true,
    	fieldLabel: '<s:text name="productos.configIncisoSumaAsegurada.listaValor"/>',
    	labelSeparator:'',
    	listWidth: 200,
		...
		focusAndSelect : function(record) {
       	...
       	onSelect : function(record, index, skipCollapse){
			...
			Ext.getCmp('hidden-combo-lista-valor-suma-asegurada').setValue(valor);
		}
	});                
...
var comboLeyenda =new Ext.form.ComboBox({
						    ...
						    displayField:'value',
						    allowBlank:false,
						    blankText : '<s:text name="productos.configCoberturaSumaAsegurada.leyenda.req"/>',
						    valueField: 'key',					    	
						    mode: 'local',
					    	triggerAction: 'all',
						    emptyText:'<s:text name="productos.configCoberturaSumaAsegurada.leyenda.sel"/>',
					    	selectOnFocus:true,
						    fieldLabel: '<s:text name="productos.configCoberturaSumaAsegurada.leyenda"/>',
						    labelSeparator:'',
					    	...
					    	selectFirst : function() {
          					...
          					onSelect : function(record, index, skipCollapse){
								...
								var valor=record.get('key');
								Ext.getCmp('hidden-combo-suma-asegurada-leyenda').setValue(valor);
							}			    	
			});
...
var leyenda = new Ext.form.Checkbox({
        boxLabel: '<s:text name="config.coberturas.sumaAsegurada.leyenda"/>',
        hideLabel: true,
        labelSeparator:'',
        id:'leyenda-check',
        name: 'leyenda',            
...
var reinstalacion = new Ext.form.Checkbox({
        boxLabel: '<s:text name="config.coberturas.sumaAsegurada.reinstalacion"/>',
        hideLabel: true,
        labelSeparator:'',
...
var revalorizaciones = new Ext.form.Checkbox({
        boxLabel: '<s:text name="config.coberturas.sumaAsegurada.revalorizacion"/>',
        hideLabel: true,
        labelSeparator:'',
...
var claveCobertura= new Ext.form.TextField({
							...
							fieldLabel: '<s:text name="config.coberturas.sumaAsegurada.cobertura"/>',
							name: 'claveCobertura',
							disabled: true,
							labelSeparator:'',
							width:65
...
var leyendaCotizacion = new Ext.form.Checkbox({
        boxLabel: '<s:text name="config.coberturas.sumaAsegurada.leyendaCotizacion"/>',
        hideLabel: true,
        labelSeparator:'',
...
var leyendaCaratula = new Ext.form.Checkbox({
        boxLabel: '<s:text name="config.coberturas.sumaAsegurada.leyendaCaratula"/>',
        hideLabel: true,
        labelSeparator:'',
...
*/				    	 	
    ...
    var sumaAseguradaIncisoWindow = new Ext.Window({
        title: '<s:text name="productos.configSumaAsegurada.titulo.inciso"/>',
        width: 395,
        height:215,        
        layout: 'fit',
        plain:true,
		...
		buttons: [{
	            	...
	            	text: '<s:text name="productos.configSumaAsegurada.btn.valorDefecto"/>',
	            	...
	            	handler:function(){
	            		...
	            		&& Ext.getCmp('hidden-valor-defecto-suma-asegurada-cobertura').getValue()!=null ){
							ExpresionesVentana2(Ext.getCmp('hidden-valor-defecto-suma-asegurada-cobertura').getValue(),"EXPRESION");
	            		}else{
