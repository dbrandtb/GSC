...
ExpresionesVentanaCondiciones = function(storeCondiciones,rec,row) {
var codigoExpresion;
...
if(row!=null){
	...
	storeCondiciones.on('load', function(){
                           //var record = storeCondiciones.getAt(row);
                           Ext.getCmp('cabecera-condiciones-form').getForm().loadRecord(record);
		...
		*************************/
    	...
    	storeExpresion.on('load', function(){
                           ...
                           Ext.getCmp('top-condiciones').getForm().loadRecord(rec);
                           if(swRecalcular == 'S'){
