...
var contentPanel = new Ext.Panel({
    ...
    var treeLoaderYui=new Ext.tree.TreeLoader({dataUrl:'ArbolListaProductos.action',
    ...
    var treeLoader= new Ext.tree.TreeLoader({
						               ...
						               dataUrl:'ArbolListaProductos.action'
					            });    
	var recargarArbol=-1;
	var idNodo=-1;
						        ...
						        listeners: {
			    				        click: function(n) {
								            ...
								            idNodo = n.attributes.codigoObjeto;
											            ...
											            conn.request ({
																url: 'SubirCodigosASession.action',
																method: 'POST',
							            ...
							            expandnode :function(n){
							            	...
							            	if(recargarArbol!=idNodo && n!=null && n.attributes.nivel=="1" && !n.isLeaf() && bandera){
														...
														var conn = new Ext.data.Connection();
											            conn.request ({
																url: 'LlenandoProductos.action',
																method: 'POST',
																successProperty : '@success',
																params : params,
											    	       		callback: function (options, success, response) {
									                   					arbolProductos.root.reload();									                          			
							       		               			},
												               	waitMsg: 'Espere por favor....'
											    		       	});
