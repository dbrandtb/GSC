...
**************************************************************/ 
  ...
  function getResultado(){
        url='flujoendoso/obtenerDatosGridClausulas.action';
...
var borrarForm3= new Ext.form.FormPanel({
        id:'borrarForm3',
        labelAlign:'top',
        border:false,
        anchor:'100%',
    ...
    var windowDel3 = new Ext.Window({
        ...
        buttons: [{
                text: 'Aceptar', 
                handler: function() {
                    if (borrarForm3.form.isValid()) {
                            borrarForm3.form.submit({          
                                waitMsg:'Procesando...',
                ...
                text: 'Cancelar',
                handler: function(){windowDel3.hide();}
            }]
        });
...
var clausulasForm = new Ext.form.FormPanel({  
       layout:'form',
        id:'clausulasForm',
        border:false,
        bodyStyle:'padding:5px 5px 0',
        ...
        items: [{
                ...
                layout:'form',
                bodyStyle:'margin-top: 10px; margin-left: 20px',
                <s:component template="builderResultClausulas.vm" templateDir="templates" theme="components" />
         ...
         ,listeners: {
            beforerender  : function() {
                       ...
                       clausulasForm.getForm().loadRecord(record);
                        });
          }//beforerender
       }//listeners
  });
...
clausulasForm.render('clausulas');
